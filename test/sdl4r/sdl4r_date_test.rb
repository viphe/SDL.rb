  ...
  class SDL4RDateTest < Test::Unit::TestCase
    ...
    def test_years
      assert_equal_date_time(
        ...
        SDL4R::create_date_time(2010, 01, 01, 1, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(1, 01, 01, 1, 11, 11.111),
        SDL4R::create_date_time(1, 01, 01, 1, 11, 11, 111))
    ...
    def test_months
      ...
      assert_equal_date_time(
        ...
        SDL4R::create_date_time(2010, 12, 01, 1, 11, 11, 111))

      assert_equal_date_time(
        local_civil_date(2011, 01, 01, 01, 11, 11.111),
        SDL4R::create_date_time(2010, 13, 01, 01, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 01, 11, 11.111),
        SDL4R::create_date_time(2010, 00, 01, 01, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2009, 12, 01, 01, 11, 11.111),
        SDL4R::create_date_time(2010, -1, 01, 01, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2009, 01, 01, 01, 11, 11.111),
        SDL4R::create_date_time(2010, -12, 01, 01, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2008, 01, 01, 01, 11, 11.111),
        SDL4R::create_date_time(2010, -24, 01, 01, 11, 11, 111))
    end
    ...
    def test_days
      ...
      assert_equal_date_time(
        ...
        SDL4R::create_date_time(2010, 01, 31, 1, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2010, 02, 28, 1, 11, 11.111),
        SDL4R::create_date_time(2010, 02, 28, 1, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2012, 02, 29, 1, 11, 11.111),
        SDL4R::create_date_time(2012, 02, 29, 1, 11, 11, 111))

      assert_equal_date_time(
        local_civil_date(2010, 02, 01, 1, 11, 11.111),
        SDL4R::create_date_time(2010, 01, 32, 1, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2010, 03, 01, 1, 11, 11.111),
        SDL4R::create_date_time(2010, 02, 29, 1, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2012, 03, 01, 1, 11, 11.111),
        SDL4R::create_date_time(2012, 02, 30, 1, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2012, 03, 01, 1, 11, 11.111),
        SDL4R::create_date_time(2012, 01, 61, 1, 11, 11, 111))

      assert_equal_date_time(
        local_civil_date(2009, 12, 31, 1, 11, 11.111),
        SDL4R::create_date_time(2010, 01, -1, 1, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2009, 11, 30, 1, 11, 11.111),
        SDL4R::create_date_time(2010, 01, -32, 1, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2009, 01, 01, 1, 11, 11.111),
        SDL4R::create_date_time(2010, 01, -365, 1, 11, 11, 111))
    end

    def test_hours
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 00, 11, 11.111),
        SDL4R::create_date_time(2010, 01, 01, 00, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 23, 11, 11.111),
        SDL4R::create_date_time(2010, 01, 01, 23, 11, 11, 111))

      assert_equal_date_time(
        local_civil_date(2010, 02, 01, 00, 11, 11.111),
        SDL4R::create_date_time(2010, 01, 31, 24, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2010, 02, 01, 01, 11, 11.111),
        SDL4R::create_date_time(2010, 01, 31, 25, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2010, 02, 02, 00, 11, 11.111),
        SDL4R::create_date_time(2010, 01, 31, 48, 11, 11, 111))
      ...
      assert_equal_date_time(
        ...
        SDL4R::create_date_time(2010, 01, 01, -24, 11, 11, 111))
      assert_equal_date_time(
        local_civil_date(2009, 12, 30, 23, 11, 11.111),
        SDL4R::create_date_time(2010, 01, 01, -25, 11, 11, 111))
    end

    def test_minutes
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 01, 59, 11.111),
        SDL4R::create_date_time(2010, 01, 01, 01, 59, 11, 111))
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 01, 00, 11.111),
        SDL4R::create_date_time(2010, 01, 01, 01, 00, 11, 111))

      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 02, 00, 11.111),
        SDL4R::create_date_time(2010, 01, 01, 01, 60, 11, 111))
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 00, 59, 11.111),
        SDL4R::create_date_time(2010, 01, 01, 01, -1, 11, 111))
      assert_equal_date_time(
        local_civil_date(2009, 12, 31, 23, 59, 11.111),
        SDL4R::create_date_time(2010, 01, 01, 01, -61, 11, 111))
    end

    def test_seconds
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 01, 01, 0.111),
        SDL4R::create_date_time(2010, 01, 01, 01, 01, 00, 111))
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 01, 01, 59.111),
        SDL4R::create_date_time(2010, 01, 01, 01, 01, 59, 111))

      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 01, 02, 0.111),
        SDL4R::create_date_time(2010, 01, 01, 01, 01, 60, 111))
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 01, 00, 59.111),
        SDL4R::create_date_time(2010, 01, 01, 01, 01, -1, 111))
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 00, 59, 59.111),
        SDL4R::create_date_time(2010, 01, 01, 01, 01, -61, 111))
    end

    def test_milliseconds
      assert_equal_date_time(
        local_civil_date(2010, 01, 01, 01, 01, 0.999),
        SDL4R::create_date_time(2010, 01, 01, 01, 01, 01, -1))
    end
  end
