...
A {Ruby implementation}[https://github.com/viphe/SDL.rb] of the Simple Declarative Language
originally developed by Dan Leuck at Ikayzo[http://ikayzo.org/display/SDL/Home].
It supports the v1.3 of the language specification.
...
Copyright 2005-2013 Ikayzo, inc.
