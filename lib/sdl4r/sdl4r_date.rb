...
# Utilities for creating DateTimes.
#
class << SDL4R
  ...
  # Example
  #
  #   create_date_time(2010, 01, 01, -2, 55, 30) => 2009/12/31 22;55:30
  #
  ...
  def create_date_time(*args)
    ...
    amend_date_time(date_time, amend_args)
  end
  ...
  #   i.e. arguments to provide to #amend_date_time
  #
  # @param create_args
  ...
  def amend_date_time(date_time, fields)
